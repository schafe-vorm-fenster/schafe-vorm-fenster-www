...
/**
 * TS-WEB-0028 D1 — the `/ueber-uns/archiv` manifest.
 *
 * `primaryConversion: null` — no conversion, no form, no hero photo (D1); the
 * closing block is the merged three-job offer (TS-WEB-0006 D6).
 *
 * `liveModules: []`: the page is fully static from the build-time media-echo
 * fetch — "no relevance engine, no island, no BFF call" (D2/D8). TS-WEB-0006 D1's
