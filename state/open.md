...
| 13 | Härtungsrunde vor Go-Live: alle `Mock aktiv`-Zeilen abarbeiten — echte APIs rein, Mocks raus, Clearances geklärt. Der Lauf liefert einen Prototyp, keine Live-Site (Mock-Regel, plan/leitplanken.md) | Jan, 2026-09-11 | hoch | Prototyp bleibt auf geschützter Preview | ja (eigene Runde) |
