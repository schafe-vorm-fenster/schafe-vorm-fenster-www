...
- Return via direct URL, via Back, via the navigation — check what
  greets you.
- Abandon mid-order and mid-briefing specifically; revisit after a
  "long" pause (new session, cleared state).
...
visitor caused innocently, orphaned validation states.
