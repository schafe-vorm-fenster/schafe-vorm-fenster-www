...
- Operate every control: search field with nested submit, chips,
  badges' links, the embedded widgets, the language switch.
- Complete every conversion path keyboard-only, including error
...
absence, Enter not submitting where it should, focus lost after
dynamic content swaps in.
