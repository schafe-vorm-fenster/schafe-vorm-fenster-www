---
name: github-issues
description: Manage GitHub issues using the @modelcontextprotocol/server-github MCP server.
layer: global
---
...
- **Structure content**: Use appropriate template from [references/templates.md](http://references/templates.md)
- **Execute**: Use MCP tools for reads, gh api for writes
...
Always use the templates in [references/templates.md](http://references/templates.md). Choose based on issue type:
