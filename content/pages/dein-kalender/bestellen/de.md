...
Vier Schritte auf einer Route (TS-WEB-0025 D2). Kein Preis-Slot — 480 €/Jahr
ist pro Organisation fix, unabhängig vom gewählten Umfang (DEC-0060).
Keine Zahlungsdaten laufen über diese Website (DEC-0011); jede Rechnung
...
zurückgestellt (DEC-0069) — dieser Schritt zeigt nur, was ausgewählt
...
Kein Zahlungsfeld, keine private Adresse (DEC-0011). Feldset ist eine
Spezifikations-Vorgabe (TS-WEB-0025 D6); die Formulierung der Labels ist
...
unbestätigt (Q-026-Erweiterung, TS-WEB-0025 D7) — der zweite Hinweistext
