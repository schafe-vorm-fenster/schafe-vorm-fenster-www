...
describe("TS-WEB-0001-A1: links in the default language stay bare", () => {
...
describe("TS-WEB-0001-A2: a prefixed language carries its prefix and its own segments", () => {
...
describe("TS-WEB-0001-A7/TS-004-A: query and fragment travel with the route", () => {
