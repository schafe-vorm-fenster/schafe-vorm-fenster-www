...
/**
 * The fill/text pairs, each one checked at badge size (SRC-0014 §Category
...
/**
 * 3 `badge` [FIXED] — SRC-0014 §Badge and chip.
 *
 ...
 * two does not reflow the row (SRC-0014 §Reserved text space).
