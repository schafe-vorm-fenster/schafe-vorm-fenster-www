/**
 * The briefing booking link — TS-WEB-0016 D7 (S3): "One configured value
 ...
 * request time (TS-WEB-0007 D3). The environment variable still wins, so a
...
/** Who receives the visitor's data by following the link (TS-WEB-0016 D9, DEC-0013). */
