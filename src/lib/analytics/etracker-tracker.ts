/**
 * The real eTracker adapter — TS-WEB-0012 D2, written but disabled.
 *
 ...
 * That verification is open (state/open.md row 12, Q-0040: "eTracker
 ...
 * action, which is the shape SRC-0010's legacy loader assumes but which the
...
interface EtrackerGlobal {
   ...
   * against the account before this adapter is enabled (Q-0040).
   */
  sendEvent?: (event: {
    category: string;
    action: string;
