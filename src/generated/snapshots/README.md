# Build-time snapshots — tier 3 (TS-WEB-0009 D8)
...
- **No counters file, and there must not be one.** TS-WEB-0009 D6 removes the
...
- **Today's files are demo data**, produced from the mock backend. The build
  step that regenerates them from the real upstreams (TS-WEB-0009-A12) is not
