---
id: DEC-0076
title: "@axe-core/playwright is the a11y sweep instrument for TS-WEB-0002-A1 and TS-WEB-0029-A12"
status: accepted
date: 2026-09-11
...
`e2e/pages/rechtliches.spec.ts` records TS-WEB-0029-A12 as a named, skipped test.
TS-WEB-0002-A1 and TS-WEB-0029-A12 are declared at tool level in
...
1280 px (the two TS-WEB-0002 reference viewports) with the WCAG 2.1 A/AA rule
...
visitor — so TS-WEB-0017 D1's runtime register does not apply (`stack.allow.json`'s
