...
Linking out avoids third-party scripts on the page (DEC-0013, DEC-0015
untouched). Booking happens under Google's terms — acceptable because it
is an outbound navigation, not an on-page embed. → FUN-WEB-0093.

## Superseded in part 2026-09-24 — DEC-0081
...
iframe, no font, no CSP entry (DEC-0013, DEC-0015 untouched).

**Withdrawn:** that the link is placed as a page CTA. The appointment link
lives in the first action row of the contact section (DEC-0081 §3); a
...
it fires on that row's click, with the route (DEC-0081 §4, TS-WEB-0016 D12).
