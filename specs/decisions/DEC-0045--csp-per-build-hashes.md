...
invocation — the failure mode DEC-0041 §8 forbids and the performance
...
- `'strict-dynamic'` still applies, so scripts loaded by a hashed script
  ...
  the written allowlist NFR-WEB-0030 requires.
- TS-WEB-0004 D6 (static + ISR) is preserved unchanged. TS-WEB-0014 D3's variant A
