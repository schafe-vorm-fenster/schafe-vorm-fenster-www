...
| Statement grammar | per-class slot forms, one modal one predicate, `form` on the artefact | **Partly closed by DEC-0087, then by DEC-0092 on 2026-09-24.** DEC-0087 recast 47 of 155 and left 108 outside their form. DEC-0092 took the whole quality class through: the 37 — not 41; DEC-0087's class denominators were transposed — were split by measure, given a measure from the artefact that already enforces it, or reclassified out of the class. 196 requirements now, 71 outside their form, all of them functional requirements and constraints |
