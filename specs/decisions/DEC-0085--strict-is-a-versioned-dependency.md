...
| Acceptance criteria shape | `acceptance_tests` with given/when/then | `DEC-0040` chose id-carrying criteria with a verification level over a uniform format, deliberately. 420 of them exist |
