...
1. **Claims are declared in content** (FUN-WEB-0036). The content schema
...
2. **List ordering is unit-tested with a spot check** (FUN-WEB-0030), not
...
3. **BFSG conformity rests on the WCAG AA regime already specified**
   (NFR-WEB-0026). The accessibility statement is fed by self-assessment
...
4. **Only phase 1 is verified** (FUN-WEB-0068). The target picture beyond
