...
- **`/mitmachen` keeps its photograph.** No cleared flyer/phone/hand photograph
  ...
  photograph stays, re-cropped onto the people (state/open.md row 267), and the
...
- **The embed scene on `/` keeps Gützkow.** The "Schaukasten + Kulturkalender"
  ...
  is a Portalize embed rather than a mockup (DEC-0068 rule 3) — row 268.
...
descriptor's own "not a portrait" warning is recorded as row 269, not argued
away.
...
- Four heroes and one portrait were re-placed; `mitmachen-hero` and
  ...
  row 270 asks whether hero photographs deserve their own byte budget.
