...
# DEC-0054 — Visual generation waits for the component layer
...
- TS-WEB-0017 D2's breakpoint proposals are superseded by the token values —
  the specs consume `breakpoint.*` and propose nothing.
- Q-0023 stays open against the narrowed contract.
