...
date) is a formal demand to the envoy side (Q-0022). The website spec
treats forms as an integration, not a feature. → FUN-WEB-0090–092.
...
(FUN-WEB-0091, FUN-WEB-0092, DEC-0025 untouched).

**Q-0022 shrinks with it**: the contact form kind leaves the demand; the
