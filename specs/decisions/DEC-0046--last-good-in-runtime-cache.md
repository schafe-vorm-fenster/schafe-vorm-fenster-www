...
DEC-0019 tier 2 — the last known answer, served with a freshness label
...
- Its keys follow the segmentation of TS-WEB-0005 D8, so Q-0030's cache
  measurement covers this store as well as the render cache.
- Resolves Q-0036. Revisit only if cold-region tier-3 hits show up as a
