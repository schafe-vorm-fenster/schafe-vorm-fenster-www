...
Live modules need app APIs (Q-0015). All ecosystem services already publish
...
operations is `specs/contracts/api-contracts.md` (SRC-0011).

## Consequences

Q-0015 is resolved except for one sliver: confirming that
