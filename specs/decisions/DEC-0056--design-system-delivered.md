...
and lifts the gate DEC-0054 held.
...
- Q-0023 is resolved; DEC-0054's gate is lifted for everything the document
  covers.
- Superseded proposals: TS-WEB-0017 D2's breakpoint numbers (tokens win),
  TS-WEB-0002 D3's weight floor (the family ships 400/700 plus 800 for
  display), TS-WEB-0003's font row (Atkinson, per DEC-0043).
...
- Icons are not a delivery: the specification names the set, and the
  website installs it into its own stack (CON-WEB-0007). The v2.0 boards
