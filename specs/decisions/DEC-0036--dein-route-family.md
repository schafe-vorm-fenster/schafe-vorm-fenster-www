...
IA amended first (DEC-0022), specs synchronised after. The naming rule is
a candidate for the communication principles in `go-to-market-os`.

## Amendment 2026-09-24 — DEC-0083
...
word for word. That string was then treated as binding — `TS-WEB-0027 D3` tagged
it `[FIXED: DEC-0036 §3]` and `TS-WEB-0027-A3` asserted it in an e2e criterion —
and the 2026-09-22 review rejected it as literally untrue (the service runs
in a data centre; SRC-0017 CG-033).
...
in `content/pages/**` under SRC-0017, and no spec states it (DEC-0083).
