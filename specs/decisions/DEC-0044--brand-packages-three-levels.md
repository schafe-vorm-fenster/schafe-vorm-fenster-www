...
is written by hand anywhere in the website (TS-WEB-0017 D3). The identity
package feeds the content pipeline (TS-WEB-0007), not the components.
...
Q-0033 is resolved: there was no competition, only a stale observation.
