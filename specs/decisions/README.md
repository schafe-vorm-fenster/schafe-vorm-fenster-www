...
- [DEC-0129 — The scene carries the module, block 2b is the scene, and `/` ends on ink — the ten choices the home composition had to take](DEC-0129--the-scene-carries-the-module-and-the-page-ends-on-ink.md)
