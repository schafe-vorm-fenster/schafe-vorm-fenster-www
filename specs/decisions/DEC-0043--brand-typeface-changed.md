...
# DEC-0043 — The brand typeface is Atkinson Hyperlegible Next

## Context

TS-WEB-0002 D3 and TS-WEB-0003 D3 were written against Catamaran, taken from the
...
- **The weight-floor question dissolves.** The family ships exactly two
  ...
  against. TS-WEB-0002 D3's floor becomes "body ≥ 400", which is the only
  option.
...
- The choice is itself an accessibility argument: Atkinson Hyperlegible
  ...
  a strong fit for WCAG AA plus the AAA basics (TS-WEB-0002 D1/D2) and for an
  audience of all ages.
- Q-0034 narrows accordingly: verify the *colour world* (Lime, Violett,
