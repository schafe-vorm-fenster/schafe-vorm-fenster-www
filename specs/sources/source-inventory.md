...
| SRC-016 | Glossary: Standardized Vocabulary — Google Doc `1c5pDyo2PpYFdhlDltrTEjNWyBtlmaILAMudeG0r1Gis` | vocabulary, governed | high | the canonical bilingual vocabulary: geographic terms, product terms, roles. To become `@schafe-vorm-fenster/glossary` (DEC-062, Q-057) | read |
