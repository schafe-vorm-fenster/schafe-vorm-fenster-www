...
decisions: [DEC-0048, DEC-0081, DEC-0082, DEC-0105, DEC-0109, DEC-0110]
ai_provenance:
  prompt_id: UNKNOWN
...
| TS-WEB-0019-A9 | e2e | DOM order on `/` is: block 1 · block 2a (the three scenes, one of them wrapping the explain module, in the D3a order for the load's trait) · provenance stamps · proof stream · context band · closing CTA · contact section, with nothing but the global footer after the contact section (TS-WEB-0006-A17). |
