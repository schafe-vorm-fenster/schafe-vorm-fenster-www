...
| WEB-F-043 | On pages whose focus job is "run our own calendar", module 1 shall be replaced by the embed demo: the **real Portalize widget via its loader** (`/api/{organizerId}/load.js`, web-component mode), filtered to the place just searched for (filter parameter: demand Q-026, incl. cookie-freedom verification). | SRC-002#live-content, DEC-030 | S3 |
