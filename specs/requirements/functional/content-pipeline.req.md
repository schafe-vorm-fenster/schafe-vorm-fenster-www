...
| WEB-F-084 | Update workflow: a content-package update triggers an agent-driven diff; resulting content updates arrive as a pull request against the website. The hub's package publish fires a `repository_dispatch` (DEC-050), closing ADR-001's open question 1. | SRC-006, SRC-009 | S2 |
