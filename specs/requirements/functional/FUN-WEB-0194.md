...
source:
  ...
  excerpt: "stream into the page"
evidence_sufficiency: S3
fit_criterion:
  scale: "acceptance criteria of FUN-WEB-0194 that pass"
  operator: "="
  value: 3
  unit: criteria
...
For a tier-1 live module, the website SHALL stream it into the rendered page.
