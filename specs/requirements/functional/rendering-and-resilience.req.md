...
| WEB-F-106 | Every module whose data arrives after the shell — above all geo-personalized content — renders a skeleton immediately and streams in. Skeletons reserve the final space at the declared ratio (WEB-Q-009), do **not** animate, and are replaced by the designed empty state after two seconds. Blocking spinners are forbidden. | DEC-033, SRC-014#skeletons, DEC-056 | S3 |
