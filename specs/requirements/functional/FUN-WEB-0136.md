...
Finding: SRC-0001 line 207 states the opposite emphasis (one primary conversion, visually unrivalled), so it does not support this permission; it comes from DEC-0082. Recorded as a deviation rather than left as a citation that does not hold (DEC-0104 §2). Corrected 2026-09-25: the `Deviation:` line below named `website-information-architecture.concept.md#L207`, which is SRC-0003 and carries "**Audiences:** 1 municipalities and funders · 2 everyone" — the quoted rule has always been line 207 of `website-communication-principles.concept.md`, this requirement's own `source_id`. Found by the SRC-0003 re-resolution run of the same day.

Deviation: `go-to-market-os/concept/website-communication-principles.concept.md#L207` requires "One primary conversion per page, above the fold, visually unrivalled". This requirement permits a second adjacent action, on DEC-0082 §3: equal weight in a page brief means the offer is equally available, not that two elements share one visual rank, so the consult sits beside the purchase at secondary treatment. The specification carries the truth (DEC-0104 §1); DEM-0064 asks the source to follow.
